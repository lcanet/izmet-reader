...
function OfflineService($http, izmetParameters, $rootScope, $location, $log, $timeout, $q) {
    ...
    service.start = function() {
        ...
        if (izmetParameters.mobile && navigator && navigator.network) {
            ...
            // listen changes to set value on rootScope
            $rootScope.$on('networkStateChange', function($ev, newState){
                $rootScope.online = service.hasNetwork();
            });
        }
